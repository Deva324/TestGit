...
class ComparableTimSort {
	...
	private ComparableTimSort(Object[] a, Object[] work, int workBase, int workLen) {
		 ...
		 * decreased. See the MIN_MERGE declaration above for more information. The
		 * maximum value of 49 allows for an array up to length Integer.MAX_VALUE-4, if
		 * array is filled by the worst case stack size increasing scenario. More
		 * explanations are given in section 4 of:
	...
	/**
	 * Sorts the given range, using the given workspace array slice for temp storage
	 * when possible. This method is designed to be invoked from public methods (in
	 ...
	 * @param start
	 *            the index of the first element in the range that is not already
	 ...
	 * @param hi
	 *            index after the last element that may be contained in the run. It
	 ...
	 * @param hint
	 *            the index at which to begin the search, 0 <= hint < n. The closer
	 ...
	 * @param base2
	 *            index of first element in second run to be merged (must be aBase +
	 *            aLen)
	 * @param len2
